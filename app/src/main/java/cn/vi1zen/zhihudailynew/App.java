...
//        mPushAgent.setDebugMode(false);
        ...
        UmengMessageHandler messageHandler = new UmengMessageHandler() {
                ...
                new Handler(getMainLooper()).post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (isClickOrDismissed) {
                            //统计自定义消息的打开
                            Log.d("Umeng", "App.java - run() ---------- 自定义消息的打开" );
                            UTrack.getInstance(getApplicationContext()).trackMsgClick(msg);
                        } else {
                            //统计自定义消息的忽略
                            Log.d("Umeng", "App.java - run() ---------- 自定义消息的忽略" );
            ...
            public Notification getNotification(Context context, UMessage msg) {
                for (Map.Entry<String, String> entry : msg.extra.entrySet()) {
                    Log.e("UMENG", "App.java - getNotification() ---------- key:value " + entry.getKey() + ":" + entry.getValue() );
                }
        ...
        UmengNotificationClickHandler notificationClickHandler = new UmengNotificationClickHandler() {
            ...
            public void dealWithCustomAction(Context context, UMessage msg) {
                Log.e("UMENG", "App.java - dealWithCustomAction() ---------- msg.custom" + msg.custom );
                for (Map.Entry<String, String> entry : msg.extra.entrySet()) {
                    Log.e("UMENG", "App.java - dealWithCustomAction() ---------- key:value " + entry.getKey() + ":" + entry.getValue() );
                }
