...
public class CarouselImageView extends FrameLayout implements View.OnClickListener {
         ...
         * 选中时圆点的颜色
         */
        private int mIndicatorSelectColor = Color.WHITE;
        /**
         * 圆点普通的颜色
         */
        ...
        public void addUrl(List<String> url) {
            ...
            for (int i = 0; i < urls.size(); i++) {
                ...
                imageView.setOnClickListener(CarouselImageView.this);
        ...
        class MyPagerAdapter extends PagerAdapter {
            ...
            public Object instantiateItem(ViewGroup container, int position) {
                ...
                if (imageView.getDrawable() == null) {
                    if (imageViewLoad != null) {
                        imageViewLoad.ImageLoad(imageView, urls.get(position));//加载图片
                    }
                }
