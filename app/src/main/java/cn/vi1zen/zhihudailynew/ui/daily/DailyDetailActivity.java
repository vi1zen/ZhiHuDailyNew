            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.itemComment:
                        Toast.makeText(DailyDetailActivity.this, "点击评论", Toast.LENGTH_SHORT).show();
            ...
            public void onNext(DailyJson dailyJson) {
                ...
                if (dailyJson.getRecommenders() == null) {
                    ...
                    toolbar.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Toast.makeText(DailyDetailActivity.this, "点击ToolBar", Toast.LENGTH_SHORT).show();
...
//                            startActivity(intent);
                ...
                Glide.with(DailyDetailActivity.this).load(dailyJson.getImage()).placeholder(R.mipmap.liukanshan).into(ivImage);
            }
        };
    ...
    private void getStoryExtra(final int id) {
        Subscriber subscriber = new Subscriber<StoryExtra>() {
            ...
            public void onNext(StoryExtra storyExtra) {
                DailyDetailActivity.this.storyExtra = storyExtra;
            }
        };
